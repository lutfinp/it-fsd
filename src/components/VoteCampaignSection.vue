...
const progress = computed(() =>
    Math.min(100, Math.round((votes.value / goal) * 100)),
);
...
const steps = [
    {
        no: "1",
        title: "Masuk",
        desc: "Gunakan akun dari email karyawan untuk bergabung ke portal voting perusahaan.",
    },
    {
        no: "2",
        title: "Pilih IT FSD",
        desc: "Temukan kategori Best Department 2026, lalu klik IT FSD.",
    },
    {
        no: "3",
        title: "Kunci Voting-mu",
        desc: "Konfirmasi pilihanmu. Satu suara dari kamu berarti segalanya.",
    },
];

const reasons = [
    "Kami selalu inisiatif duluan",
    "Respon cepat di setiap sprint",
    "Kami ada untuk anda",
];
</script>
            ...
            <div class="vote-box">
                <div class="text-center">
                    ...
                    <h2 class="section-title">
                        Vote <span class="grad">IT FSD</span> sebagai Best
                        Proactive Department
                    </h2>
                    <p class="section-desc">
                        Proaktif bukan sekadar kata bagi kami — itu budaya.
                        Bantu wujudkan kemenangan yang sudah layak kami raih
                        dengan satu suara darimu.
                    </p>
                </div>
          ...
          <div class="progress-track">
            <div class="progress-fill" :style="{ width: progress + '%' }">
              <span class="progress-tip">{{ progress }}%</span>
                ...
                <div class="vote-cta">
                    <a
                        href="https://vote.bgp-corporation.co.id"
                        target="_blank"
                        class="btn btn-vote"
                        >🗳️ Vote IT FSD Sekarang</a
                    >
                ...
                <!-- Alasan -->
                <div class="reasons">
                    <span v-for="r in reasons" :key="r" class="reason-chip"
                        >✦ {{ r }}</span
                    >
                </div>
...
.reason-chip {
    font-size: 0.85rem;
    color: var(--text);
    border: 1px solid rgba(52, 207, 235, 0.4);
